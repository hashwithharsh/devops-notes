# Project Management and Jira Concepts

## Why project management matters to a DevOps engineer

A DevOps engineer is not working only with servers.

You may receive work such as:
...
That work needs to be tracked.

## Common work items

### Epic

Large business/technical area.

### Story

A user-focused requirement.
...
Something that is not behaving as expected.

### Sub-task

Smaller work under a task/story.
...
> "Create CI pipeline for Python application."
...
This converts one vague requirement into trackable engineering work.
...
### Practical: turn a DevOps request into trackable work

Suppose I receive:

> "Set up CI/CD for the application."

I would not create one giant task.

I break it down:

```text
Epic: Application CI/CD

Story: Build pipeline
  Task: checkout
  Task: unit tests
  Task: Docker build
...
Each item should have an owner, acceptance criteria and evidence of completion.

This is how project-management knowledge becomes useful in actual DevOps work.
...
For **Project Management Jira**, the workflow I want to remember is:
...
```text
task, create, devops, work, change, result, build, docker, explain, story, text, useful
```
...
> "The reason we use Project Management Jira here is because it gives us a repeatable way to handle project management jira. The practical part is that I can inspect the current state, make the intended change, verify it, and troubleshoot it without relying on manual guesswork."
